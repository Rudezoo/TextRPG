...
void Show_Status(_tagPlayer *tPlayer) {
	while (1) {
		...
		cout << "무기 : " << tPlayer->iEquipped[0]->strName << endl;
		cout << "방어구 : " << tPlayer->iEquipped[1]->strName << endl;
...
void Menu_Equip(_tagPlayer* tPlayer) {
	...
	while (1) {
		...
		cout << "2. 방어구"<<endl;
		cout << endl;
		cout << "장착할 아이템의 종류를 고르세요 [뒤로 가기는 0번] :";
		...
		case SM_WEAPON:
			while (1)
			{
				...
				cout << "장착할 무기의 번호를 입력해주세요[뒤로가기는 0번] : ";
				cin >> iMenu;
				...
				if (iMenu <= weapon_count && weapon_count>0) {
					cout << weapons[iMenu - 1]->strName << "가 장착되었습니다!" << endl;
		...
		case SM_ARMOR:
			while (1)
			{
				...
				if (iMenu <= armor_count && armor_count > 0) {
					cout << armors[iMenu - 1]->strName << "가 장착되었습니다!" << endl;
...
void Menu_UnEquip(_tagPlayer* tPlayer) {
	...
	while (1) {
		...
		cout << "1. 무기" << endl;
		cout << "2. 방어구" << endl;
		cout << "해제할 장비의 번호를 입력해주세요 [뒤로가기는 0번]  : ";
